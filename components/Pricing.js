    ...
    <section className="py-6 text-neutral-focus">
      <div className="container p-4 mx-auto sm:p-10">
        <div className="mb-12 space-y-4 text-center">
          ...
          <div>
            <button className="px-4 py-1 font-semibold border rounded-l-lg btn-info">
              Monthly
            </button>
        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">
          <div className="flex flex-col overflow-hidden border-2 rounded-md dark:border-coolGray-700">
            <div className="flex flex-col items-center justify-center px-2 py-8 space-y-4 dark:bg-coolGray-800">
              <p className="text-lg font-medium">Personal</p>
              <p className="text-5xl font-bold">
                0$
                <span className="text-xl dark:text-coolGray-400"> /mo</span>
              </p>
            </div>
            <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-coolGray-900">
              ...
              <button className="btn btn-success px-8 py-3 mt-6">
                Sign up
              </button>
            </div>
          </div>
